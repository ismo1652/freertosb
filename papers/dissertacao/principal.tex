...
% OBS: opção 'compatible' por esse motivo:
% 'Run in compatibility mode. Older tex files may need this op-
% tion selected to be able to compile. In the latest version of nomencl
% the commands \makeglossary and \printglossary were replaced
% with \makenomenclature and \printnomenclature. Selecting this
% option will redefine the old commands, but will loose the compatibil-
% ity with other glossary packages
\usepackage[portuguese,noprefix,compatible]{nomencl}
%\usepackage[portuguese,noprefix,compatible,refeq,refpage]{nomencl}
...
\bibliographystyle{abnt-num.bst}
...
% Cap. 2 - Introdução
\include{trabalhos/trabalhos}

% Cap. 3 - FreeRTOS
\include{freertos/freertos}

% Cap. 4 - M?etodo B
\include{metodob/metodob}

% Cap. 5 - Figuras, gráficos e tabelas
\include{escopo/escopo}

% Cap. 4 - Figuras, gráficos e tabelas
\include{modelagem_inicial/modelagem_inicial}

% Cap. 5 - Conclusões
\include{modelagem_atual/modelagem_atual}

%Cap 6
\include{consideracoes_finais/consideracoes_finais}
