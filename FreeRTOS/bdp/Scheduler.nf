...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(Scheduler))==(active);
  List_Variables(Machine(Scheduler))==(active);
  External_List_Variables(Machine(Scheduler))==(active)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(Scheduler))==(active: BOOL)
END
&
THEORY ListAssertionsX IS
  Expanded_List_Assertions(Machine(Scheduler))==(btrue);
  Abstract_List_Assertions(Machine(Scheduler))==(btrue);
  Context_List_Assertions(Machine(Scheduler))==(BIT <: NATURAL & QUEUE_LENGTH <: QUEUE_QUANT);
  List_Assertions(Machine(Scheduler))==(btrue)
END
&
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(Scheduler))==(active:=FALSE);
  Context_List_Initialisation(Machine(Scheduler))==(skip);
  List_Initialisation(Machine(Scheduler))==(active:=FALSE)
END
&
...
THEORY ListPreconditionX IS
  List_Precondition(Machine(Scheduler),startScheduler)==(active = FALSE);
  List_Precondition(Machine(Scheduler),stopScheduler)==(active = TRUE);
  List_Precondition(Machine(Scheduler),suspendScheduler)==(active = TRUE);
  List_Precondition(Machine(Scheduler),resumeScheduler)==(active = TRUE)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(Scheduler),resumeScheduler)==(active = TRUE | active:=TRUE);
  Expanded_List_Substitution(Machine(Scheduler),suspendScheduler)==(active = TRUE | active:=TRUE);
  Expanded_List_Substitution(Machine(Scheduler),stopScheduler)==(active = TRUE | active:=FALSE);
  Expanded_List_Substitution(Machine(Scheduler),startScheduler)==(active = FALSE | active:=TRUE);
  List_Substitution(Machine(Scheduler),startScheduler)==(active:=TRUE);
  List_Substitution(Machine(Scheduler),stopScheduler)==(active:=FALSE);
  List_Substitution(Machine(Scheduler),suspendScheduler)==(active:=TRUE);
  List_Substitution(Machine(Scheduler),resumeScheduler)==(active:=TRUE)
END
&
...
THEORY VariablesEnvX IS
  Variables(Machine(Scheduler)) == (Type(active) == Mvl(btype(BOOL,?,?)))
END
&
