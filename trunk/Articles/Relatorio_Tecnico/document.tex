...
$\mathbf{QUEUE_BASIC}$ responsável por especificar comportamentos que se
...
Na figura \ref{fig:xQueueGenericSend} tem-se a especificação da operação
$\mathit{xQueueGenericSend}$. Nela,\ldots
