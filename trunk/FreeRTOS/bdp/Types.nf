...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(Types))==(BIT,QUEUE_NULL,ITEM_NULL,TASK_NULL,ITEM_EMPTY,REMOVE_EVENT,PRIORITY,TICK,TICK_INCREMENT,MAX_DELAY,NULL_PARAMETER);
  Inherited_List_Constants(Machine(Types))==(?);
  List_Constants(Machine(Types))==(BIT,QUEUE_NULL,ITEM_NULL,TASK_NULL,ITEM_EMPTY,REMOVE_EVENT,PRIORITY,TICK,TICK_INCREMENT,MAX_DELAY,NULL_PARAMETER)
END
&
THEORY ListSetsX IS
