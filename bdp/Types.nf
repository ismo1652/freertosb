...
THEORY ListAssertionsX IS
  ...
  List_Assertions(Machine(Types))==(BIT <: NATURAL & QUEUE_LENGTH <: QUEUE_QUANT)
END
&
...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(Types))==(BIT,QUEUE_NULL,ITEM_NULL,TASK_NULL,ITEM_EMPTY,REMOVE_EVENT,PRIORITY,TICK,TICK_INCREMENT,MAX_DELAY,NULL_PARAMETER,semGIVE_BLOCK_TIME,IDLE_PRIORITY,QUEUE_LENGTH,QUEUE_QUANT);
  Inherited_List_Constants(Machine(Types))==(?);
  List_Constants(Machine(Types))==(BIT,QUEUE_NULL,ITEM_NULL,TASK_NULL,ITEM_EMPTY,REMOVE_EVENT,PRIORITY,TICK,TICK_INCREMENT,MAX_DELAY,NULL_PARAMETER,semGIVE_BLOCK_TIME,IDLE_PRIORITY,QUEUE_LENGTH,QUEUE_QUANT)
END
&
THEORY ListSetsX IS
